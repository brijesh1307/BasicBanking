...
public class activity_send_to_user extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    public void onUserListener(int position) {
        ...
        startActivity(new Intent(activity_send_to_user.this, MainActivity.class));
        finish();
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitButton = new AlertDialog.Builder(activity_send_to_user.this);
        builder_exitButton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton ("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick (DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(activity_send_to_user.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(activity_send_to_user.this, activity_users_list.class));
                        finish();
                    }
